...
dependencies {
    implementation("cc.sighs.oelib:OELib-neoforge-26.1:0.3.0-SNAPSHOT")
    implementation("curse.maven:jei-238222:8108851")
    compileOnly("curse.maven:curios-309927:7925547")
}
